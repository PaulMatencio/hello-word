...
export class Contract {
      ...
      isPaused: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('isPaused',
                                     ...
                                     'PausableToken.compact line 33 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      pause: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('pause',
                                     'argument 1 (as invoked from Typescript)',
                                     'PausableToken.compact line 38 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
      ...
      unpause: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('unpause',
                                     'argument 1 (as invoked from Typescript)',
                                     'PausableToken.compact line 45 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
      ...
      mint: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('mint',
                                     'argument 1 (as invoked from Typescript)',
                                     'PausableToken.compact line 52 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      transfer: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('transfer',
                                     'argument 1 (as invoked from Typescript)',
                                     'PausableToken.compact line 63 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(fromAccount_0).concat(_descriptor_0.toValue(to_0).concat(_descriptor_1.toValue(amount_0))),
      ...
      balanceOf: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('balanceOf',
                                     'argument 1 (as invoked from Typescript)',
                                     'PausableToken.compact line 78 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
  ...
  _getUserSecret_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'object' && result_0.bytes.buffer instanceof ArrayBuffer && result_0.bytes.BYTES_PER_ELEMENT === 1 && result_0.bytes.length === 32)) {
      __compactRuntime.typeError('getUserSecret',
                                 'return value',
                                 'PausableToken.compact line 21 char 1',
  ...
  _mint_0(context, partialProofData, to_0, amount_0) {
    ...
    __compactRuntime.assert(!this._equal_2(to_0, new Uint8Array(32)),
                            'PausableToken: invalid receiver');
    const currentBal_0 = this._balanceOf_0(context, partialProofData, to_0);
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('PausableToken.compact line 58 char 42: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(currentBal_0 + amount_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
    ...
    const tmp_1 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('PausableToken.compact line 59 char 26: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
  ...
  _transfer_0(context, partialProofData, fromAccount_0, to_0, amount_0) {
    this._assertNotPaused_0(context, partialProofData);
    __compactRuntime.assert(!this._equal_3(fromAccount_0, new Uint8Array(32)),
                            'PausableToken: invalid sender');
    __compactRuntime.assert(!this._equal_4(to_0, new Uint8Array(32)),
                            'PausableToken: invalid receiver');
    const fromBal_0 = this._balanceOf_0(context, partialProofData, fromAccount_0);
    __compactRuntime.assert(fromBal_0 >= amount_0,
                            'PausableToken: insufficient balance');
    ...
    const tmp_1 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('PausableToken.compact line 73 char 42: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(toBal_0 + amount_0);
    __compactRuntime.queryLedgerState(context,
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'PausableToken.compact line 17 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
