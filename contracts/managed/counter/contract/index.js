...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      increment: (...args_1) => {
        ...
        if (!(typeof(by_0) === 'bigint' && by_0 >= 0n && by_0 <= 4294967295n)) {
          __compactRuntime.typeError('increment',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(by_0),
        ...
        const result_0 = this._increment_0(context, partialProofData, by_0);
  ...
  _increment_0(context, partialProofData, by_0) {
    __compactRuntime.assert(by_0 > 0n,
                            'Increment step must be greater than zero');
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('counter.compact line 15 char 11: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
